...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-4xl mx-auto">
                ...
                <div class="px-6 pb-6">
                    ...
                    <div class="space-y-4">
                        <div class="flex justify-between items-center mb-4">
                            ...
                            <button @click="$dispatch('open-modal', { id: 'editNamaModal' })"
            ...
            <x-custom-modal id="editNamaModal" title="Ubah Nama Pengguna" :action="route('profile.update')" method="PUT"
                buttonText="Simpan Perubahan" maxWidth="sm:max-w-md" :is_edit_modal="$errors->has('name')">
                <div class="space-y-4">
                    <div>
