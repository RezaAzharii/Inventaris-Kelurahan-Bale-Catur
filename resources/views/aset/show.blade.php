        ...
        <div class="bg-gray-50 p-6 rounded-lg">
            ...
            <script>
                function downloadQRCode() {
                    // Gunakan library html2canvas untuk konversi yang lebih baik
                    const container = document.getElementById('qrcode-container');
                    const svg = container.querySelector('svg');

                    // Tambahkan margin/padding untuk quiet zone
                    const padding = 20;
                    ...
                    img.onload = function() {
                        ...
                        // Download dengan kualitas tinggi
            ...
            <!-- Tambahkan library html2canvas untuk fallback -->
